...
(* ========================================================================== *)
(*  TES - d(curly R)/dE' kernel CSV export                                     *)
(*                                                                            *)
...
(*  Output: output/TES/dcurlyRdEprime_csv/Al_{heavy,light}.csv                  *)
(* ========================================================================== *)
...
outDir   = FileNameJoin[{mathDir, "output", "TES", "dcurlyRdEprime_csv"}];
...
EBOLD   = 0.1;            (* TES bold observed energy E' [eV]; MKID uses 0.2 *)
sigPar  = TESsig;
kerL    = KerRAll;       (* left  kinematic branch *)
kerR    = KerRAlr;       (* right kinematic branch *)
detTag  = "Al";

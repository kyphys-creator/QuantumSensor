...
class DarkMatterQuantumAnalysis:
    ...
    def __init__(self, config: RunConfig):
        ...
        #    With disk_fraction = p set, the eta driving the fit is the mixture
        #    (1-p)*Halo + p*Disk; both components carry the same local DM density,
        #    so the mixture's density is independent of p. eta_halo / eta_disk are
        #    kept (the latter only when mixing) for the comparison plot.
        if config.disk_fraction is None:
